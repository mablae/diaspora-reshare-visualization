d3 = function () {
    ...
    function ge(n) {
        function t(t) {
            ...
            var s, h, g, p, d, m, v, y, M, x, b, _, w, S = {point: r, lineStart: i, lineEnd: o, polygonStart: function () {
    ...
    function xr(n, t) {
        ...
        return o[0] != c[0] || o[1] != c[1] ? (r.push("translate(", null, ",", null, ")"), i.push({i: 1, x: Mr(o[0], c[0])}, {i: 3, x: Mr(o[1], c[1])})) : c[0] || c[1] ? r.push("translate(" + c + ")") : r.push(""), l != f ? (l - f > 180 ? f += 360 : f - l > 180 && (l += 360), i.push({i: r.push(r.pop() + "rotate(", null, ")") - 2, x: Mr(l, f)})) : f && r.push(r.pop() + "rotate(" + f + ")"), s != h ? i.push({i: r.push(r.pop() + "skewX(", null, ")") - 2, x: Mr(s, h)}) : h && r.push(r.pop() + "skewX(" + h + ")"), g[0] != p[0] || g[1] != p[1] ? (e = r.push(r.pop() + "scale(", null, ",", null, ")"), i.push({i: e - 4, x: Mr(g[0], p[0])}, {i: e - 2, x: Mr(g[1], p[1])})) : (1 != p[0] || 1 != p[1]) && r.push(r.pop() + "scale(" + p + ")"), e = i.length, function (n) {
    ...
    function _r(n, t) {
        ...
        for (n += "", t += "", lc.lastIndex = 0, r = 0; e = lc.exec(t); ++r)e.index && l.push(t.substring(o, c = e.index)), f.push({i: l.length, x: e[0]}), l.push(null), o = lc.lastIndex;
    ...
    var Fa = {svg: "http://www.w3.org/2000/svg", xhtml: "http://www.w3.org/1999/xhtml", xlink: "http://www.w3.org/1999/xlink", xml: "http://www.w3.org/XML/1998/namespace", xmlns: "http://www.w3.org/2000/xmlns/"};
    va.ns = {prefix: Fa, qualify: function (n) {
        var t = n.indexOf(":"), e = n;
        return t >= 0 && (e = n.substring(0, t), n = n.substring(t + 1)), Fa.hasOwnProperty(e) ? {space: Fa[e], local: n} : n
    ...
    var mo = /(?:([^{])?([<>=^]))?([+\- ])?(#)?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i, vo = va.map({b: function (n) {
        return n.toString(2)
    }, c: function (n) {
    ...
    var wo, So = new bt, Eo = {sphere: function () {
        wo += 4 * Ba
    ...
    var ko, Ao, No, qo, To, Co, zo, Do, jo, Lo, Ho, Fo = {sphere: f, point: Lt, lineStart: Ft, lineEnd: Pt, polygonStart: function () {
        Fo.lineStart = Ot
    }, polygonEnd: function () {
        Fo.lineStart = Ft
    ...
    var Yo, Uo, Io, Vo, Xo, Zo, Bo = {point: f, lineStart: f, lineEnd: f, polygonStart: function () {
        Uo = 0, Bo.lineStart = ie
    }, polygonEnd: function () {
        Bo.lineStart = Bo.lineEnd = Bo.point = f, Yo += Math.abs(Uo / 2)
    }}, $o = {point: ue, lineStart: f, lineEnd: f, polygonStart: f, polygonEnd: f}, Wo = {point: ce, lineStart: le, lineEnd: fe, polygonStart: function () {
        Wo.lineStart = se
    }, polygonEnd: function () {
    ...
    var Jo, Go = {sphere: f, point: f, lineStart: Te, lineEnd: f, polygonStart: f, polygonEnd: f}, Ko = Ce(function (n) {
    ...
    var rc = va.map({linear: Re, "linear-closed": Ye, step: Ue, "step-before": Ie, "step-after": Ve, basis: Je, "basis-open": Ge, "basis-closed": Ke, bundle: Qe, cardinal: Be, "cardinal-open": Xe, "cardinal-closed": Ze, monotone: ur});
    ...
    var fc = function () {
        return st
    }, sc = va.map({linear: fc, poly: zr, quad: function () {
        return qr
    }, cubic: function () {
        return Tr
    }, sin: function () {
        ...
        return Pr
    }}), hc = va.map({"in": st, out: Ar, "in-out": Nr, "out-in": function (n) {
        return Nr(Ar(n))
    }});
    va.ease = function (n) {
    ...
    var mc = va.map({"inside-out": function (n) {
    ...
    }, "default": oi}), vc = va.map({silhouette: function (n) {
    ...
    var kc = va.map({circle: wu, cross: function (n) {
    ...
    va.svg.brush = function () {
        ...
        function i() {
            ...
            function p() {
                var n = i(), u = !1;
                y && (n[0] += y[0], n[1] += y[1]), k || (va.event.altKey ? (v || (v = [(f[0][0] + f[1][0]) / 2, (f[0][1] + f[1][1]) / 2]), N[0] = f[+(n[0] < v[0])][0], N[1] = f[+(n[1] < v[1])][1]) : v = null), S && d(n, o, 0) && (e(_), u = !0), E && d(n, c, 1) && (r(_), u = !0), u && (t(_), b({type: "brush", mode: k ? "move" : "resize"}))
            }
        ...
        var u, a = d(n, "brushstart", "brush", "brushend"), o = null, c = null, l = Hc[0], f = [
            [0, 0],
            [0, 0]
        ], s = [!0, !0];
    ...
    var Lc = {n: "ns-resize", e: "ew-resize", s: "ns-resize", w: "ew-resize", nw: "nwse-resize", ne: "nesw-resize", se: "nwse-resize", sw: "nesw-resize"}, Hc = [
        ["n", "e", "s", "w", "nw", "ne", "se", "sw"],
        ["e", "w"],
        ["n", "s"],
        []
    ...
    var Bc = Lu(Ic), $c = Hu(Ic), Wc = Lu(Vc), Jc = Hu(Vc), Gc = Lu(Xc), Kc = Hu(Xc), Qc = Lu(Zc), nl = Hu(Zc), tl = /^%/, el = {"-": "", _: " ", 0: "0"}, rl = {a: function (n) {
        return Vc[n.getDay()]
    }, A: function (n) {
        return Ic[n.getDay()]
    }, b: function (n) {
        ...
        return"%"
    }}, il = {a: Pu, A: Ou, b: Iu, B: Vu, c: Xu, d: Ku, e: Ku, H: na, I: na, j: Qu, L: ra, m: Gu, M: ta, p: ia, S: ea, U: Yu, w: Ru, W: Uu, x: Zu, X: Bu, y: Wu, Y: $u, "%": aa}, ul = /^\s*\d+/, al = va.map({am: 0, pm: 1});
    ...
    var cl = [1e3, 5e3, 15e3, 3e4, 6e4, 3e5, 9e5, 18e5, 36e5, 108e5, 216e5, 432e5, 864e5, 1728e5, 6048e5, 2592e6, 7776e6, 31536e6], ll = [
        [va.time.second, 1],
        [va.time.second, 5],
        [va.time.second, 15],
        [va.time.second, 30],
